...
// TODO: sort/separate based on CSS Levels ???
export type CSSColorValueType =
    'black'
    | 'silver'
    | 'gray'
    | 'white'
...
export type ColorType =
    ...
    | [CSSColorValueType, number | string] // ['red',    .5 | '50%']
...
// | [[CSSColorValueType, number | string], number | string] // [['red',    .5], .5 | '50%']
