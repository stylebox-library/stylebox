...
describe('basics', () => {
  ...
  test('parse([number, number]) - color with alpha', () => {
    ...
    expect(parse(styles, [0x123456, .5])).toBe(true)
  ...
  test('parse({ background: ... })', () => {
    ...
    expect(parse(styles, { background: ['red', .5] })).toBe(true)
  ...
  test('parse({ fill: ... })', () => {
    ...
    expect(parse(styles, { fill: [0x123456, .75] })).toBe(true)
  ...
  test('parse({ stroke: ... })', () => {
    ...
    expect(parse(styles, { stroke: ['0x123456', .75] })).toBe(true)
